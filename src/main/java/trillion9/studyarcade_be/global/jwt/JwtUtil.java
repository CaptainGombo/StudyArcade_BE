...
public class JwtUtil {
    ...
    public static final long ACCESS_TOKEN_TIME = 1 * 60 * 1000L;   //AccessToken Time 1 hour
    public static final long REFRESH_TOKEN_TIME = 2 * 60 * 60 * 1000L; //RefreshToken Time 1 day
